...
#import "LunchMovieViewController.h"
#import "LogicTest.h"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    {
        LunchMovieViewController *wsCtrl = [[LunchMovieViewController alloc]init];
        ...
        UINavigationController *rootTabCtrl = [storyBoard instantiateViewControllerWithIdentifier:@"RootNavigationVC"];
